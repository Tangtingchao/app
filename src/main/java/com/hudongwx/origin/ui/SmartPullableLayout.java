...
public class SmartPullableLayout extends ViewGroup implements NestedScrollingParent {
    ...
    private static final float DECELERATE_INTERPOLATION_FACTOR = 2.1f; // 滑动阻力因子
    ...
    private int mLastMoveY;//最后按下的位置
...
//                    updateState(State.PULL_DOWN_RELEASE);
    ...
    public void setRefreshing(){
        mHandler.sendEmptyMessageDelayed(State.PULL_DOWN_RELEASE,500);
    }
